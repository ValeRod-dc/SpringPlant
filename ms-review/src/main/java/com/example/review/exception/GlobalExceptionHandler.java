...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleReviewNotFound(ReviewNotFoundException ex) {
        ...
        return new ErrorResponse(404, "Review no encontrada", errors);
    }
    ...
    public ErrorResponse handleFeignNotFound(FeignException.NotFound ex) {
        HashMap<String, String> errors = new HashMap<>();
        errors.put("mensaje", "El recurso solicitado no existe");
        return new ErrorResponse(404, "No encontrado", errors);
    }
    ...
    public ErrorResponse handleFeignError(FeignException ex) {
        HashMap<String, String> errors = new HashMap<>();
        errors.put("mensaje", "Un servicio no está disponible. Intente más tarde.");
